...
class Module implements ModuleDefinitionInterface
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            'Ns\User\Controllers' => __DIR__ . '/controllers/',
            'Ns\User\Models'      => __DIR__ . '/models/',
            'Ns\User\Libraries'   => __DIR__ . '/libraries/',
            'Ns\User\Helpers'     => __DIR__ . '/helpers/',
            'Ns\User\Plugin'      => __DIR__ . '/plugin/',
        ));
...
//            $eventsManager->attach('dispatch:beforeDispatch', new SecurityPlugin);
            ...
            $dispatcher = new Dispatcher;
            $dispatcher->setDefaultNamespace("Ns\User\Controllers");
