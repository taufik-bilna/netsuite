...
class Module implements ModuleDefinitionInterface
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            'Ns\Customer\Controllers' => __DIR__ . '/controllers/',
            'Ns\Customer\Models'      => __DIR__ . '/models/',
            'Ns\Customer\Libraries'   => __DIR__ . '/libraries/',
            'Ns\Customer\Helpers'     => __DIR__ . '/helpers/',
            'Ns\Customer\Plugin'      => __DIR__ . '/plugin/',
        ));
...
//            $eventsManager->attach('dispatch:beforeDispatch', new SecurityPlugin);
            ...
            $dispatcher = new Dispatcher;
            $dispatcher->setDefaultNamespace("Ns\Customer\Controllers");
